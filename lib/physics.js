...
export class PhysicsManager {
  ...
  createOtherPlayerBody(x, y, z, playerHeight, playerRadius) {
    ...
    const playerBodyDesc = RAPIER.RigidBodyDesc.dynamic()
      .setTranslation(x, y, z)
      .setLinearDamping(0.1) // Lower damping to allow movement
      .setAngularDamping(1.0) // Keep some angular damping
      .setCanSleep(false)
    ...
    .setFriction(0.0) // Low friction like local player
    .setRestitution(0.0)
    .setDensity(1.0) // Normal density
    ...
    scene.traverse((child) => {
      if (child.isMesh && child.userData.physicsBody) {
        ...
        if (body.bodyType() === RAPIER.RigidBodyType.Dynamic) {
          ...
          // Apply full gravity to other players - server will override if needed
          // This ensures they fall properly and don't float
          body.setLinvel({
