...
export default class Engine {
    ...
    static loop() {
        // CRITICAL FIX: Update vehicles BEFORE physics 
        // This ensures input affects vehicle params before physics applies them
        VehicleManager.updateVehicles();
        
        // Update controller and handle inputs
        ControlManager.update();
        
        // Update physics after inputs and vehicle updates
        Physics.update();
