...
export default class Engine {
    ...
    static setup(canvas) {
        ...
        // Note: SceneManager.setup now handles vehicle creation
        SceneManager.setup();
    ...
    static loop() {
        ...
        // CRITICAL FIX: Verify there's only one camera being used
        if (this.camera.parent !== this.scene && this.camera.parent !== null) {
            console.log(`Camera parent is: ${this.camera.parent.name || this.camera.parent.type || 'unknown'}`);
        }
