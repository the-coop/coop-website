...
export default class PlayerManager {
    ...
    static createFirstPersonHands() {
        ...
        leftHandMesh.rotation.set(Math.PI * 1.5, Math.PI, 0); // Added Math.PI to Y rotation
        leftHandMesh.name = 'firstPersonLeftHand';

        // Left hand fingers and thumb - mirrored positions
        const leftFingers = [
            ...
            // Thumb - mirrored position and rotation
            createFinger(
        ...
        rightHandMesh.rotation.set(Math.PI * 1.5, Math.PI, 0); // Added Math.PI to Y rotation
        rightHandMesh.name = 'firstPersonRightHand';

        // Right hand fingers and thumb - mirrored positions
        const rightFingers = [
