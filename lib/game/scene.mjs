...
export default class SceneManager {
    ...
    static setupVehicles() {
        ...
        // IMPROVED: Use more varied positions to prevent any chance of overlap
        const vehiclePositions = [
            // Positions with carefully varied coordinates to avoid any possibility of duplication
            { position: new Vector3(5000, 500, 300), type: 'car', id: 'car-1' },
            { position: new Vector3(5010, 610, 510), type: 'car', id: 'car-2' },  // Adjusted more significantly
            { position: new Vector3(4985, 705, 495), type: 'car', id: 'car-3' },  // Adjusted more significantly
            { position: new Vector3(5520, 820, 318), type: 'car', id: 'car-4' },  // Adjusted more significantly
            { position: new Vector3(5025, 915, 423), type: 'car', id: 'car-5' },  // Adjusted more significantly
            { position: new Vector3(4972, 1025, 237), type: 'car', id: 'car-6' }, // Adjusted more significantly
            { position: new Vector3(5037, 1115, 312), type: 'car', id: 'car-7' }, // Adjusted more significantly
            { position: new Vector3(5043, 1242, 527), type: 'car', id: 'car-8' }, // Adjusted more significantly
            
            // Airplanes at even higher altitude with unique positions
            { position: new Vector3(5087, 1587, 227), type: 'airplane', id: 'airplane-9' },  // Adjusted more significantly
            { position: new Vector3(4943, 2043, 197), type: 'airplane', id: 'airplane-10' }, // Adjusted more significantly
            { position: new Vector3(5112, 2574, 243), type: 'airplane', id: 'airplane-11' }  // Adjusted more significantly
        ];
