...
export default class SceneManager {
    ...
    static setupVehicles() {
        ...
        const carPositions = [
            { lat: 0, lon: 0, height: 150 },           // ADJUSTED: Reduced from 200 to 150 for better landing
            { lat: 30, lon: 45, height: 160 },         // ADJUSTED: Reduced from 220 to 160
            { lat: -30, lon: 90, height: 170 },        // ADJUSTED: Reduced from 240 to 170
            { lat: 45, lon: -45, height: 180 },        // ADJUSTED: Reduced from 260 to 180
            { lat: -45, lon: -90, height: 190 },       // ADJUSTED: Reduced from 280 to 190
            { lat: 15, lon: 180, height: 200 },        // ADJUSTED: Reduced from 300 to 200
            { lat: 60, lon: 120, height: 210 },        // ADJUSTED: Reduced from 320 to 210
            { lat: -60, lon: -120, height: 220 }       // ADJUSTED: Reduced from 340 to 220
        ];
        ...
        try {
            ...
            if (typeof VehicleManager.createAirplane === 'function') {
                const planePositions = [
                    { lat: 10, lon: 20, height: 300 },    // ADJUSTED: Reduced from 400 to 300 for better handling
                    { lat: -20, lon: -30, height: 320 },  // ADJUSTED: Reduced from 450 to 320
                    { lat: 45, lon: 140, height: 340 }    // ADJUSTED: Reduced from 500 to 340
                ];
