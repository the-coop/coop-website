...
export default class SceneManager {
    ...
    static setup() {
        ...
        this.planets = [
            { radius: 1000, color: 0x800080, watercolor: 0x0000ff, position: [0, -2000, 0], CoF: 0.2 },    // Main planet below (doubled size)
            { radius: 600, color: 0x404040, watercolor: 0x0000ff, position: [2500, 0, 0], CoF: 0.2 }      // Second planet to side (doubled size and further away)
        ].map((planetdata) => {
