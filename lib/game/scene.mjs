...
export default class SceneManager {
    ...
    static setup() {
        ...
        // Create specific vehicles instead of generic ones
        VehicleManager.createCar(this.planets[0], 10, 45);  // Create a car on Alpha planet at lat 10, long 45
        VehicleManager.createAirplane(this.planets[1], -15, 90);  // Create an airplane on Beta planet at lat -15, long 90
        
        // Log info about vehicles for debugging
        console.log(`Created ${VehicleManager.vehicles.length} vehicles (car and airplane) on planets`);
