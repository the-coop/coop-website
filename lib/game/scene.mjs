...
export default class SceneManager {
    ...
    static setup() {
        ...
        // Create vehicles on planets after they've been created
        VehicleManager.createPlanetVehicles();
        
        // Log info about vehicles for debugging
        console.log(`Created ${VehicleManager.vehicles.length} vehicles on planets`);
    };
};
