...
export default class SceneManager {
    ...
    static setup() {
        ...
        this.planets = [
            { radius: 2000, color: 0x800080, watercolor: 0x0000ff, position: [0, -4000, 0], CoF: 0.2 },    // Even larger main planet
            { radius: 1200, color: 0x404040, watercolor: 0x0000ff, position: [5000, 0, 0], CoF: 0.2 }      // Even larger second planet, further away
        ].map((planetdata) => {
