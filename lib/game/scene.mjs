...
export default class SceneManager {
    ...
    static setupVehicles() {
        ...
        const alphaVehiclePositions = [
            ...
            new Vector3(-800, 12000, 600),    // 16000 units above planet center (15800 above surface)
            new Vector3(800, 12500, -600),    // 16500 units above planet center
            new Vector3(600, 13000, 800),     // 17000 units above planet center 
            new Vector3(-600, 13500, -800),   // 17500 units above planet center
            new Vector3(-300, 14000, 900),    // 18000 units above planet center
            new Vector3(900, 14500, 300),     // 18500 units above planet center
            new Vector3(400, 15000, -900),    // 19000 units above planet center
            new Vector3(-900, 15500, -400)    // 19500 units above planet center
        ];
        ...
        alphaVehiclePositions.forEach((position, index) => {
            try {
                ...
                if (car) {
                    ...
                    car.userData.gravityFactor = 0.03; // Even lower gravity to slow the fall
        ...
        try {
            if (typeof VehicleManager.createVehicleWithPosition === 'function') {
                const planePositions = [
                    ...
                    new Vector3(-700, 16000, -700),  // 20000 units above planet center 
                    new Vector3(700, 16500, 700),    // 20500 units above planet center
                    new Vector3(0, 17000, -1000)     // 21000 units above planet center
                ];
