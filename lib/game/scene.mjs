...
export default class SceneManager {
    ...
    static setupVehicles() {
        console.log("Setting up vehicles on planets - using lower heights for better visibility");
        ...
        // SIGNIFICANTLY REDUCED: Use about 1/4 of the original height values 
        // Alpha planet is at [0, -4000, 0] so we'll spawn vehicles much closer to it
        const alphaVehiclePositions = [
            // MUCH LOWER: Y values are now about 1/4 of original heights
            new Vector3(0, 700, 0),     // Was 3000, now 700
            new Vector3(200, 750, 200), // Was 3200, now 750
            new Vector3(-200, 800, -200), // Was 3400, now 800
            new Vector3(300, 850, -300), // Was 3600, now 850
            new Vector3(-300, 900, 300), // Was 3800, now 900
            new Vector3(0, 950, 400),   // Was 4000, now 950
            new Vector3(400, 1000, 0),   // Was 4200, now 1000
            new Vector3(-400, 1050, -400) // Was 4400, now 1050
        ];
        ...
        alphaVehiclePositions.forEach((position, index) => {
            try {
                ...
                if (car) {
                    ...
                    // REMOVED: Initial gravity impulse - natural gravity will work instead
                }
            } catch (e) {
        ...
        try {
            if (typeof VehicleManager.createVehicleWithPosition === 'function') {
                const planePositions = [
                    // MUCH LOWER: Heights reduced to about 1/4 of original values
                    new Vector3(100, 1100, 100),  // Was 4500, now 1100
                    new Vector3(-100, 1150, -100), // Was 4700, now 1150
                    new Vector3(200, 1200, -200)   // Was 4900, now 1200
                ];
        ...
        if (this.planets.length > 1) {
            ...
            if (beta && beta.object) {
                ...
                // MUCH LOWER: Heights reduced to about 1/4 of original values
                // Beta planet is at [5000, 0, 0] so spawn closer to it
                const betaVehiclePositions = [
                    new Vector3(5000, 500, 200),   // Was 2000, now 500
                    new Vector3(5100, 550, 100),   // Was 2200, now 550
                    new Vector3(4900, 600, -100),  // Was 2400, now 600
                    new Vector3(5200, 650, 0)      // Was 2600, now 650
                ];
                ...
                if (typeof VehicleManager.createVehicleWithPosition === 'function') {
                    const betaPlanePositions = [
                        new Vector3(5000, 700, 0),    // Was 3000, now 700
                        new Vector3(5100, 750, 100)   // Was 3200, now 750
                    ];
