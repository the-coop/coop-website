...
export default class SceneManager {
    ...
    static setupVehicles() {
        ...
        // Create vehicles on the first planet (Alpha)
        if (this.planets[0]) {
            const alpha = this.planets[0];
            // Create cars at various strategic locations
            ...
            // Create an airplane on Alpha planet too
            VehicleManager.createAirplane(alpha, 30, 120);
        }
        
        // Create vehicles on the second planet (Beta)
        if (this.planets[1]) {
            ...
            // Create an airplane on Beta planet too
