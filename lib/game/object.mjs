...
export default class ObjectManager {
    ...
    static checkCollision(object1, object2) {
        ...
        // CRITICAL FIX: Always process vehicle collisions
        const isVehicle1 = object1.userData?.isVehicle || object1.userData?.type === 'car' ||
                           object1.userData?.type === 'vehicle' || object1.userData?.type === 'airplane';
        const isVehicle2 = object2.userData?.isVehicle || object2.userData?.type === 'car' ||
                           object2.userData?.type === 'vehicle' || object2.userData?.type === 'airplane';
        
        // If vehicles are involved, ensure bounds are updated
        if (isVehicle1) {
            this.updateCollidableBounds(object1);
        }
        if (isVehicle2) {
            this.updateCollidableBounds(object2);
        }
