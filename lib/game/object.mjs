...
export default class ObjectManager {
    ...
    // Check for collisions between two objects using OBB
    static checkCollision(object1, object2) {
        ...
        if (object1.userData && object2.userData) {
            // Check if this is player-vehicle collision where player is inside the vehicle
            const isPlayerVehicleCollision = 
                (object1.userData.isPlayer && object2.userData.isVehicle && object2.userData.isOccupied && 
                 object2.userData.player && object2.userData.player.handle === object1) ||
                (object2.userData.isPlayer && object1.userData.isVehicle && object1.userData.isOccupied && 
                 object1.userData.player && object1.userData.player.handle === object2);
            
            if (isPlayerVehicleCollision) {
                return false; // Skip collision detection for occupied vehicles and their drivers
            }
        }
        ...
        const obb1 = object1.userData.obb;
        const obb2 = object2.userData.obb;
