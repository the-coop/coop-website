                        ...
                        if (intersects) {
                            try {
                                ...
                                if (time <= timeStep && time < closestTime) {
                                    ...
                                    if (typeof window !== 'undefined' && window.gameNotify && item.type !== player._lastCollidedWith) {
                                        window.gameNotify(`Collision with ${item.type}`);
                                        player._lastCollidedWith = item.type;
