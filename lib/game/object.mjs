...
export default class ObjectManager {
    ...
    static checkCollision(object1, object2) {
        ...
        // IMPROVED: More complete checks for player-vehicle collision filtering
    ...
    static alignObjectToSurface(object, surfaceNormal, options = {}) {
        ...
        try {
            ...
            // Skip alignment for falling objects unless forced
            if (settings.skipIfFalling && isFalling && !settings.forceFullAlignment) {
                return false;
            }
