...
export default class VehicleManager {
    ...
    // ENHANCED: Improved wheel reset method with better steering handling
    static resetWheelsBaseOrientation(vehicle) {
        ...
        try {
            ...
            // CRITICAL FIX: Ensure all wheels are at the correct base rotation
            Object.entries(wheels).forEach(([wheelName, wheel]) => {
                ...
                if (wheelName.includes('front')) {
                    wheel.rotation.set(
                        ...
                        steeringAngle,        // Apply steering angle directly
