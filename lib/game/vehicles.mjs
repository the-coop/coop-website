...
export default class VehicleManager {
    ...
    static createCar(planet, latitude, longitude, heightOffset = 3) {
        ...
        car.userData.rotateWheels = function(angle, targetSteeringAngle = 0) {
            // Set rolling rotation (X-axis) for all wheels
            ...
            // Apply the gradual steering angle to front wheels
            if (this.wheels.frontLeft) this.wheels.frontLeft.rotation.y = this.currentSteeringAngle;
            if (this.wheels.frontRight) this.wheels.frontRight.rotation.y = this.currentSteeringAngle;
        };
