...
export default class VehicleManager {
    ...
    static createCar(planet, latitude, longitude, heightOffset = 3) {
        ...
        // Keep wheels well above ground to prevent initial collision
        const wheelFL = new Mesh(wheelGeometry, wheelMaterial);
        wheelFL.position.set(-3, -0.5, 3); // Raised from -1.0 to -0.5 to stay above ground
        ...
        wheelFR.position.set(3, -0.5, 3); // Raised from -1.0 to -0.5
        ...
        wheelRL.position.set(-3, -0.5, -3); // Raised from -1.0 to -0.5
        ...
        wheelRR.position.set(3, -0.5, -3); // Raised from -1.0 to -0.5
