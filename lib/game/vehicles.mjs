...
export default class VehicleManager {
    ...
    static handleCarInput(car, deltaTime) {
        ...
        if (car === this.currentVehicle && 
           (car.userData?.isActivelyControlled || car.userData?._controlledByCarController)) {
            return;
        }
    ...
    static enforceSurfaceContact(car) {
        // Skip this method entirely for CarController controlled cars
        if (car.userData._controlledByCarController) {
            return;
        }
    ...
    static updateCar(car, deltaTime) {
        ...
        // Skip physics processing for CarController-controlled cars
        if (car === this.currentVehicle && 
            (car.userData?.isActivelyControlled || car.userData?._controlledByCarController)) {
