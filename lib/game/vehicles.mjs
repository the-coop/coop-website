...
export default class VehicleManager {
    ...
    static createCarOnSurface(planet, latitude, longitude, heightOffset = 3) {
        try {
            ...
            car.userData.maxSpeed = 20; // REDUCED from 30 for better control
            car.userData.acceleration = 0;
            car.userData.drag = 0.05;
            car.userData.bounceFactor = 0.01; // REDUCED: From 0.03 to 0.01 - much less bouncy
            car.userData.landingDamping = 0.98; // INCREASED: From 0.97 to 0.98
            car.userData.fixedHeightOffset = 2.5; // REDUCED: From 2.8 for better ground contact
            car.userData.gravityFactor = 0.2; // REDUCED: From 0.3 to 0.2
            car.userData.rotationDamping = 0.99;
            car.userData.freshlySpawned = true;
            car.userData.stabilizationFactor = 0.98; // INCREASED: From 0.95 to 0.98
            car.userData.needsStabilization = false; // Will be set to true upon landing
            
            // ADDED: Flag to indicate this is a car (useful for physics)
    ...
    static setupCarComponents(vehicle) {
        ...
        try {
            ...
            vehicle.userData.maxSpeed = 20; // REDUCED from 30 for better control
            vehicle.userData.acceleration = 0;
            vehicle.userData.drag = 0.05;
            vehicle.userData.bounceFactor = 0.01; // REDUCED: From 0.03 to 0.01 - much less bouncy
            vehicle.userData.landingDamping = 0.98; // INCREASED: From 0.97 to 0.98
            vehicle.userData.fixedHeightOffset = 2.5; // REDUCED: From 2.8 for better ground contact
            vehicle.userData.gravityFactor = 0.2; // REDUCED: From 0.3 to 0.2
