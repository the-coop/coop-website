...
export default class VehicleManager {
    ...
    static createCar(planet, latitude, longitude, heightOffset = 3) {
        ...
        // FIXED: Position wheels even higher to fully eliminate ground clipping
        const wheelFL = new Mesh(wheelGeometry, wheelMaterial);
        wheelFL.position.set(-3, -0.6, 3); // Raised from -0.7 to -0.6 for complete clearance
        ...
        wheelFR.position.set(3, -0.6, 3); // Raised from -0.7 to -0.6
        ...
        wheelRL.position.set(-3, -0.6, -3); // Raised from -0.7 to -0.6
        ...
        wheelRR.position.set(3, -0.6, -3); // Raised from -0.7 to -0.6
