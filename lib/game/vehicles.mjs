...
export default class VehicleManager {
    ...
    static createCar(planet, latitude, longitude, heightOffset = 3) {
        ...
        // FIXED: Position wheels higher to prevent ground clipping
        const wheelFL = new Mesh(wheelGeometry, wheelMaterial);
        wheelFL.position.set(-3, -0.7, 3); // Raised from -0.8 to -0.7 to prevent clipping
        ...
        wheelFR.position.set(3, -0.7, 3); // Raised from -0.8 to -0.7
        ...
        wheelRL.position.set(-3, -0.7, -3); // Raised from -0.8 to -0.7
        ...
        wheelRR.position.set(3, -0.7, -3); // Raised from -0.8 to -0.7
