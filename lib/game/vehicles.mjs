...
export default class VehicleManager {
    ...
    static exitVehicle() {
        ...
        try {
            ...
            // FIXED: Ensure vehicle stays properly aligned to planet after exiting
            ...
            if (vehicle.userData && vehicle.userData.planet) {
                ...
                // Force proper alignment with planet surface
                this.alignVehicleToPlanetSurface(vehicle, toSurface, 0.8, true);
                
                // Reset vehicle physics state for proper movement
                if (vehicle.userData.velocity) {
                    vehicle.userData.velocity.set(0, 0, 0);
                }
                vehicle.userData._physicsControlled = true;
