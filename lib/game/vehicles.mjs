...
export default class VehicleManager {
    ...
    static tryEnterNearbyVehicle() {
        ...
        let closestDistance = 20; // INCREASED: From 5 to 20 units for easier interaction
        ...
        console.log(`Found ${vehicleCount} vehicles total, closest distance: ${closestDistance.toFixed(2)}`);
