...
export default class VehicleManager {
    ...
    // FIXED: Improved wheel reset method that properly applies steering angle
    static resetWheelsBaseOrientation(vehicle) {
        ...
        try {
            ...
            // CRITICAL FIX: Get steering angle directly from vehicle userData
            ...
            Object.entries(wheels).forEach(([wheelName, wheel]) => {
                ...
                if (wheelName.includes('front')) {
                    wheel.rotation.set(
                        ...
                        Math.PI/2           // Maintain perpendicular orientation
                    );
                } else {
