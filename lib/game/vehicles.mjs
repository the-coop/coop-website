...
export default class VehicleManager {
    ...
    static createCar(planet, latitude, longitude, heightOffset = 3) {
        ...
        // Create better collision box with proper dimensions
        const collisionBox = new Box3().setFromObject(physicsHandle);
        
        // ENHANCED: Debug visualization to verify physics shape position
        const boxHelper = new Box3Helper(collisionBox, 0xFF0000);
        boxHelper.visible = false; // Set to true to debug collision shapes
        car.add(boxHelper);
        car.userData.boundingBox = collisionBox;
        car.userData.boxHelper = boxHelper;
        
        // Register car with enhanced OBB collision 
        car.collidable = ObjectManager.registerCollidable(car, collisionBox, 'vehicle', false);
