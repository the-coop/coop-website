...
export default class ControlManager {
    ...
    static attemptVehicleInteraction() {
        ...
        // ADDED: Verify vehicle has proper type before attempting controller selection
        if (VehicleManager.currentVehicle && VehicleManager.verifyVehicleType) {
            VehicleManager.verifyVehicleType(VehicleManager.currentVehicle);
        }
