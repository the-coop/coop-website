...
import FirstPersonCarController from './controllers/FirstPersonCarController.mjs';
import FirstPersonAirplaneController from './controllers/FirstPersonAirplaneController.mjs';
...
export default class ControlManager {
    ...
    // Get the paired controller (for view switching)
    static getPairedController(controller) {
        if (controller === FPSController) return ThirdPersonController;
        if (controller === ThirdPersonController) return FPSController;
        if (controller === CarController) return FirstPersonCarController;
        if (controller === FirstPersonCarController) return CarController;
        if (controller === AirplaneController) return FirstPersonAirplaneController;
        if (controller === FirstPersonAirplaneController) return AirplaneController;
        return null;
    }
}
