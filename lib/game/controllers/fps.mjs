...
export default class FPSController {
    ...
    static movement = {
        speed: 200, // Increased from 50
        sprint: 400, // Increased from 200
        jump: 25
    };
    ...
    static onResize() {
        if (PlayerManager.protagonist && PlayerManager.protagonist.camera) {
            ...
            if (canvas) {
                ...
                PlayerManager.protagonist.camera.aspect = canvas.clientWidth / canvas.clientHeight;
    ...
    static onPointerLockChange() {
        ...
        if (!this.isPointerLocked) {
            // Resize the window/renderer after exiting pointer lock
            this.onResize();
        }
    }
