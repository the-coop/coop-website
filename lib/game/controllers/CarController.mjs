...
export default class CarController {
    ...
    static reset() {
        console.log('Initializing Car Controller with surface-aligned movement');
        ...
        try {
            ...
            // CRITICAL: Initialize surface normal immediately
    ...
    static setupCamera() {
        ...
        try {
            ...
            // Set camera up vector aligned with surface normal
    ...
    // CRITICAL: Update surface normal and store it in the car
    ...
    static handleCarMovement(car) {
        ...
        // CRITICAL: Move car along planet surface
    ...
    static moveCarOnSurface(car) {
        ...
        try {
            ...
            // CRITICAL: Project forward onto tangent plane of planet surface
            ...
            // CRITICAL: Update surface normal after moving
            this.updateSurfaceNormal(car);
            
            // Re-align car to the new surface normal
            this.alignCarToSurface(car);
    ...
    // Align car orientation to planet surface
    ...
    // Update camera position behind car
    static updateCameraPosition(car) {
        if (!car || !Engine.camera) return;
        
        try {
            // Get latest surface normal for camera orientation
