...
export default class CarController {
    ...
    static update() {
        ...
        // CRITICAL FIX: Pass input to VehicleManager
        VehicleManager.input = this.input;
        
        // Add debug logging to verify inputs are being passed
        if (this.input.movement.lengthSq() > 0.01) {
            console.log(`Car Controller passing movement input: ${this.input.movement.toArray()}`);
        }
