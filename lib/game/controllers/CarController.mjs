...
export default class CarController {
    ...
    static alignCarToSurface(car, surfaceNormal) {
        ...
        try {
            ...
            if (upDot > 0.99) return; // Already aligned
            ...
            const strength = Math.min(1.0, this.alignmentStrength * 3.0); // Stronger than regular alignment
    ...
    // ADDED: Implement general align method for external use
    static align(car, surfaceNormal, lerpFactor = 0.1) {
        return this.alignCarToSurface(car, surfaceNormal);
    }
    ...
    static handleCarMovementOnPlanet(car) {
        ...
        try {
            ...
            if (car.userData.velocity && car.userData.velocity.lengthSq() > 0.0001) {
                ...
                // IMPROVED: Apply more aggressive height correction to prevent floating
                const planetCenter = planet.object.position;
            ...
            // IMPROVED: More aggressive surface alignment to keep car firmly on ground
            this.alignCarToSurface(car, surfaceNormal);
