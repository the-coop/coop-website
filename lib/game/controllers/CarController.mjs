...
export default class CarController {
    ...
    static handleCarMovement(car, deltaTime) {
        ...
        const accelerationInput = this.input.movement.z; // Changed from negative to positive for intuitive control
        
        // CRITICAL FIX: Consistent steering direction regardless of car movement
        const steeringInput = this.input.movement.x; // FIXED: Direct mapping for intuitive control
