...
export default class CarController {
    ...
    static snapToSurface(car, planet) {
        ...
        try {
            ...
            // CRITICAL FIX: Use a more appropriate height offset for proper wheel placement
            // This is the distance from the planet surface to the car's center
            const heightOffset = car.userData.fixedHeightOffset || 1.4; // Adjusted to get wheels on surface
    ...
    static snapToSurface(car, planet) {
        ...
        try {
            ...
            const heightOffset = 0.7; // Exact value for wheels to touch ground
