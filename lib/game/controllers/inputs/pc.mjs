...
export default class PC {
    ...
    static update() {
        ...
        // Handle view switching (O key) - toggle between FPS and Third Person
        if (this.active['KeyO'] && !this.viewSwitchPressed) {
            this.viewSwitchPressed = true;
            
            // Switch between FPS and Third Person controllers
            ...
            if (typeof window !== 'undefined' && window.gameNotify) {
                const viewMode = ControlManager.controller === ThirdPersonController ? 
                    'Third Person View' : 'First Person View';
                window.gameNotify(`Switched to ${viewMode}`);
            }
