...
export default class Mobile {
    ...
    static update() {
        // Do not attempt to calculate with missing controller or StartMenuController
        if (!ControlManager.controller || ControlManager.controller === StartMenuController) return;
        
        // Make sure controller has valid input objects
        if (!ControlManager.controller.input || !ControlManager.controller.input.movement || !ControlManager.controller.input.rotation) return;
