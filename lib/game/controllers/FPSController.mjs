    ...
    static update(player, camera) {
        ...
        try {
            ...
            if ((PlayersManager.self.falling && !PlayersManager.self.standingOnObject) && 
                ...
                // Ensure falling flag is reset whenever we're grounded
                if (PlayersManager.self.falling && PlayersManager.self.currentlyColliding) {
                    console.log("Collision while on surface - preserving grounded state");
