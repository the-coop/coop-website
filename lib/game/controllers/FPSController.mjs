...
export default class FPSController {
    ...
    static reset() {
        ...
        try {
            ...
            // IMPROVED: Clear vehicle relationship flags when switching to FPS controller
            // This ensures we don't have any lingering vehicle collision exclusion flags
            ...
            if (PlayersManager.self.mesh && PlayersManager.self.handle) {
                ...
                // Force camera into player mesh (synchronously, no setTimeout)
                console.log('Forcing camera into player mesh');
            ...
            console.log('FPSController reset complete - camera should now be attached to player mesh');
        } catch (e) {
