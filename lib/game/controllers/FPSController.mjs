    ...
    static reset() {
        ...
        try {
            ...
            if (PlayersManager.self.mesh && PlayersManager.self.handle) {
                ...
                // CRITICAL FIX: Ensure camera is completely detached before attaching to player
                if (Engine.camera.parent) {
                    console.log(`Detaching camera from ${Engine.camera.parent.name || Engine.camera.parent.type || "unknown parent"}`);
                ...
                console.log("Camera reset to neutral orientation");
                ...
                console.log("Camera attached to player mesh at position (0, 1, 0)");
