...
export default class FPSController {
    ...
    //        Math.min(Math.PI * 0.45, this.surfacePitch + this.input.rotation.y)
        ...
        this.surfacePitch = this.surfacePitch + this.input.rotation.y;
        ...
        if (this.input.jump && this.input.LandedFrames == 0) {
            ...
            PlayersManager.self.velocity.multiplyScalar(0.2); // a slow down to stop the crazy speed from bunny hopping
