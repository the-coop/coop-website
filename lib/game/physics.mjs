...
export default class Physics {
    ...
    static maintainVehicleHeight(vehicle) {
        ...
        try {
            ...
            if (vehicle.userData.type === 'car') {
                heightOffset = 0.7; // Exact offset for cars to place wheels on ground
            } else if (vehicle.userData.type === 'airplane') {
                heightOffset = 0.8; // Reduced offset for airplanes to eliminate gap
            } else {
        ...
        try {
            ...
            if (object.userData.falling && 
                ...
                if (object.userData.type === 'car') {
                    heightOffset = 0.7; // Exact offset for cars
                } else if (object.userData.type === 'airplane') {
                    heightOffset = 0.8; // Reduced offset for airplanes
                } else {
    ...
    static maintainObjectSurfaceHeight(object) {
        ...
        try {
            ...
            let heightOffset;
            if (object.userData.type === 'car') {
                heightOffset = 0.7; // Wheels exactly on ground
            } else if (object.userData.type === 'airplane') {
                heightOffset = 0.8; // Reduced from 5.0 to eliminate gap
            } else {
