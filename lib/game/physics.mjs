...
export default class Physics {
    ...
    static applyVehiclePhysics(vehicle) {
        ...
        try {
            ...
            // FIXED: Increase car height offset further to prevent wheel clipping (2.0 instead of 1.5)
            const heightOffset = vehicle.userData.type === 'car' ? 2.0 : 2;
    ...
    static stabilizeVehicleOnSurface(vehicle, surfaceNormal) {
        ...
        try {
            ...
            if (vehicle.userData.type === 'car') {
                ...
                // For cars, ensure they're positioned at the right height above surface
                if (vehicle.userData.planet) {
                    ...
                    // FIXED: Ensure car is at least 2.0 units above the surface
