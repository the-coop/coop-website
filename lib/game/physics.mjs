...
export default class Physics {
    ...
    static maintainObjectSurfaceHeight(object) {
        ...
        try {
            ...
            if (object.userData.type === 'car') {
                heightOffset = object.userData.fixedHeightOffset || 3.0;
            ...
            // ADDED: Progressive height correction with increasing tolerance over time
            ...
            if (object.userData.fullyStabilized) {
                heightTolerance = 0.5; // Much larger tolerance for stable objects
            }
    ...
    static resolveCollision(objA, objB, planet) {
        try {
            ...
            // Calculate separation based on relative masses (heavier objects move less)
