...
export default class Physics {
    ...
    static applyVehiclePhysics(vehicle) {
        ...
        try {
            ...
            // All non-current vehicles are stationary - no complex physics needed
            // Just ensure they're aligned properly to the planet surface
            ...
            // Align non-player vehicles to planet surface
            VehicleManager.alignVehicleToPlanetSurface(vehicle, surfaceNormal, 0.8);
            
            // Ensure they have zero velocity/speed
