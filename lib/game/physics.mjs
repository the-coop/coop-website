                    ...
                    try {
                        ...
                        if (player.handle && player.collidable) {
                            ...
                            if (wallCount > 0) {
                                ...
                                // ADDED: Force validation of all wall OBBs
                        ...
                        if (collide) {
                            ...
                            // IMPROVED: Stronger safety buffer for wall collisions
                            const safetyOffset = collisionNormal.clone().multiplyScalar(0.5); // Increased substantially from 0.25
                            const safePosition = collisionPosition.clone().add(safetyOffset);
                            
                            // Apply position correction with safety buffer
                            ...
                            const speedDamp = 0.7; // Increased for stronger bounce
