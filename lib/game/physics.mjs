...
export default class Physics {
    ...
    // Align an object to the planet surface - simplified to use ObjectManager
    static alignObjectToPlanetSurface(object, surfaceNormal) {
        // UPDATED: Use the centralized alignment method in ObjectManager
        return ObjectManager.alignObjectToSurface(object, surfaceNormal, {
            lerpFactor: 0.1,
            skipIfFalling: false, // Physics should align even falling objects gradually
