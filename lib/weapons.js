...
export class WeaponSystem {
  ...
  updateWeaponVisibility() {
    ...
    // Hide/show appropriate weapon models
    this.viewModelGroup.visible = !isThirdPerson && !isInVehicle;
    this.thirdPersonWeaponGroup.visible = isThirdPerson && !isInVehicle && this.currentWeapon.type !== 'hands';
  }
