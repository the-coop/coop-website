...
export class RemotePlayer {
  ...
  updateState(state) {
    ...
    // Update grounded and swimming states
  ...
  update(deltaTime) {
    ...
    // For network players, we primarily trust the server state
    // Only apply physics for smooth interpolation between updates
    ...
    // For swimming, apply buoyancy
    if (this.isSwimming && this.physics.isPositionInWater) {
      const isInWater = this.physics.isPositionInWater(playerPos);
      if (isInWater) {
