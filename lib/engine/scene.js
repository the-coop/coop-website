...
export class SceneManager {
  ...
  spawnTestCar(position) {
    ...
    const car = this.vehicles.createVehicle(carId, 'car', {
  ...
  spawnTestHelicopter(position) {
    ...
    const helicopter = this.vehicles.createVehicle(helicopterId, 'helicopter', {
      position: position.clone(),
      rotation: new THREE.Quaternion(),
      isLocal: true
    });
  ...
  spawnTestPlane(position) {
    ...
    const plane = this.vehicles.createVehicle(planeId, 'plane', {
      position: position.clone(),
      rotation: new THREE.Quaternion(),
      isLocal: true
    });
  ...
  spawnTestSpaceship(position) {
    ...
    const spaceship = this.vehicles.createVehicle(spaceshipId, 'spaceship', {
      position: position.clone(),
      rotation: new THREE.Quaternion(),
      isLocal: true
    });
  ...
  spawnTestRock(position) {
    ...
    const rock = this.dynamicObjects.spawnObject({
      id: rockId,
      type: 'rock',
      position: position.clone(),
      rotation: new THREE.Quaternion(
