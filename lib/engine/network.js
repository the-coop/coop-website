                ...
                if (message.players) {
                  message.players.forEach(player => {
                    ...
                    if (player.id !== this.playerId && this.onPlayerJoin) {
                      // Call onPlayerJoin with id and position
                      this.onPlayerJoin(player.id, player.position);
                      
                      // Immediately send a state update if rotation is provided
                      if (player.rotation && this.onPlayerUpdate) {
                        // Send a full state update to properly initialize the remote player
