...
export class FPSController {
  ...
  update(deltaTime) {
    ...
    // Handle camera toggle (O key) - this should work whether in vehicle or not
    if (this.keys.toggleCamera && !this.wasTogglingCamera) {
      this.wasTogglingCamera = true;
      this.toggleCamera();
    } else if (!this.keys.toggleCamera) {
      this.wasTogglingCamera = false;
    }
