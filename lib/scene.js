 ...
 this.scene.add(ramp);
  ...
  spawnMultiplayerVehicle(objectId, position = null, scale = null) {
    ...
    import('./carController.js').then(({ CarController }) => {
      ...
      console.log(`Vehicle ${objectId} created`);
    }).catch(err => {
      console.error('Failed to load car controller:', err);
    });
  }
