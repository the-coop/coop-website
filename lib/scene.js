 ...
 this.scene.add(rock);
  ...
  createPlatform() {
    ...
    if (this.gameMode === 'sandbox') {
      // Calculate car spawn position
      // Platform top = 30 + platformHeight/2 = 31.5
      // Add enough height for car chassis + wheels + suspension
      const carSpawnHeight = 30 + platformHeight/2 + 2; // 2 units above platform surface
