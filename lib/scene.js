...
export class SceneManager {
  ...
  updateOtherPlayer(playerId, playerData, worldOriginOffset) {
    ...
    console.log(`Updating player ${playerId} - world pos: [${worldPosition.x.toFixed(1)}, ${worldPosition.y.toFixed(1)}, ${worldPosition.z.toFixed(1)}], local pos: [${localPosition.x.toFixed(1)}, ${localPosition.y.toFixed(1)}, ${localPosition.z.toFixed(1)}], origin offset: [${worldOriginOffset.x.toFixed(1)}, ${worldOriginOffset.y.toFixed(1)}, ${worldOriginOffset.z.toFixed(1)}]`);
    ...
    // Store server data for physics correction - this is the key fix
    ...
    console.log(`Player ${playerId} update - server pos: [${localPosition.x.toFixed(1)}, ${localPosition.y.toFixed(1)}, ${localPosition.z.toFixed(1)}], grounded: ${parsedData.isGrounded}`);
  }
