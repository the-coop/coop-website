...
export class FPSController {
  ...
  handleMovement(deltaTime) {
    ...
    // FIXED: Don't normalize here - we want to preserve the individual axis magnitudes
    // Normalizing was causing backward movement to be slower when combined with strafe
    ...
    if (this.isGrounded) {
      ...
      // Add surface adhesion for slopes
