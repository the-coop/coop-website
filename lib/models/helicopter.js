...
export function createHelicopterModel() {
  ...
  lights.group.children.forEach(light => heliGroup.add(light));
  ...
  heliGroup.userData.lights = lights.lights;
  heliGroup.userData.landingGear = {
    left: heliGroup.children.find(child => child.userData?.gearSide === 'left'),
    right: heliGroup.children.find(child => child.userData?.gearSide === 'right')
  };
...
function createAircraftLights() {
  ...
  lights.strobeWhite.position.set(0, 0.5, -8);
