...
import InputManager from './gameplay/inputManager';
...
export default function engine(instance) {
    ...
    // Calculate elapsed game time. Check thats its not too long 
    WORLD.deltaTime = Math.min(engineCurrentTime - enginePreviousTime,30 / 1000);
    ...
    WORLD.timeIncrement = Math.max(WORLD.timeIncrement + WORLD.deltaTime, 30 / 1000);
