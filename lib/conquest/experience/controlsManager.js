...
export default class ControlsManager {
    ...
    static toggleCameraTemp() {
        if (WORLD.settings.view.DESIRED_CAMERA_KEY === this.CAMERA_KEYS.FIRST_PERSON)
            WORLD.settings.view.DESIRED_CAMERA_KEY = this.CAMERA_KEYS.TRACKBALL;
        else
