...
export default class ComputerInput {
    ...
    static aimEuler = new Euler(0, 0, 0, 'ZYX');
    static aimSpeed = Math.PI / 180;
    ...
    static mousemove(ev) {
        ...
        if (WORLD.me.player) {
            ...
            // console.log(this.aimEuler, this.rotationSpeed);
            ...
            // Tested here instead of in player loop. Made no difference.
            // WORLD.me.player.mesh.quaternion.copy(aim);
        }
    }
