...
export default class Physics {
    ...
    static applyMovement(elapsed, player, playerHeight, surfaceHeight, isSelf) {
        ...
        if (isSelf) {
            x = PLAYER_SPEED * ((+ControlsManager.keypad.a) - (+ControlsManager.keypad.d));
            y = PLAYER_SPEED * ((+ControlsManager.keypad.w) - (+ControlsManager.keypad.s));
