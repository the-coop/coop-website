export default function updateOrbits() {
    ...
    //Should be renamed to period not speed
    // Modifier for overall orbit speed.
    const orbitBaseSpeed = 5;
  
    // Orbital parameters in seconds.
    const earthPivotPeriod = 5000 * orbitBaseSpeed;
    ...
    earthPivot.rotation.z = 2 * Math.PI * timeIncrement / moonSpherePeriod;
