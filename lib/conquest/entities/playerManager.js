...
const generateCharacter = config => {
    ...
    const armGeometry = new BoxGeometry(bodyDepth / 2, 1, bodyDepth / 2);
    ...
    const legGeometry = new BoxGeometry(bodyDepth / 2, 1, bodyDepth / 2);
    ...
    lowerLeftArm.position.set(0, -1.05, 0);
    lowerRightArm.position.set(0, -1.05, 0);
