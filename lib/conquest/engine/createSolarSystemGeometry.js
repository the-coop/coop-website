...
export function createEarthGroup() {
  ...
  earthGeometry.userData = { testing: false };
  earthGeometry.testing = 'WTF?';
  ...
  triangles.map((triangle, index) => {
    ...
    facePointerGeometry.heh = { conquestType: 'STRUCTURE' };
    facePointerGeometry.data = 'STRUCTURE';

    faceStructureBox.heh = { conquestType:  'STRUCTURE' };
    faceStructureBox.data = 'STRUCTURE';
  ...
  earthSphere.userData = { testing: false, random: true };
  earthSphere.wtf = 'why me?';
