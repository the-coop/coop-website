...
export default class GroundPlayerManager {
    ...
    static spawn(playerConfig) {
        ...
        // Add label to mesh.
        playerMesh.add(generateLabel(playerConfig.username));
        ...
        window.GROUND_LEVEL.players[playerConfig.id] = {
        ...
        return window.GROUND_LEVEL.players[player.id];
    }
