<template>
  <div class="mobile-interface">
    ...
    <div class="touch-buttons">
      <button class="touch-button jump-button" @touchstart="onJump" @touchend="onJumpEnd">
        Jump
      </button>
      <button class="touch-button sprint-button" @touchstart="onSprint" @touchend="onSprintEnd">
        Sprint
      </button>
    </div>
  </div>
...
<script setup>
  ...
  const onJump = () => ControllerManager.setInput('mobile', 'jump', true);
  const onJumpEnd = () => ControllerManager.setInput('mobile', 'jump', false);
  
  const onSprint = () => ControllerManager.setInput('mobile', 'sprint', true);
  const onSprintEnd = () => ControllerManager.setInput('mobile', 'sprint', false);
</script>
